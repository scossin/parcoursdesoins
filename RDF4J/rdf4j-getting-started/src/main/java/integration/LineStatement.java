	...
	public Set<Statement> getStatements(){
		...
		if (this.predicateIRI.equals(TIME.HASBEGINNING) || this.predicateIRI.equals(TIME.HASEND)){
			...
			if (this.predicateIRI.equals(TIME.HASBEGINNING)){
				...
				statements.add(Util.vf.createStatement(this.idEventIRI, this.predicateIRI, timeInstantStart,contextIRI));
				...
				statements.add(Util.vf.createStatement(this.idEventIRI, this.predicateIRI, timeInstantEnd,contextIRI));;
		...
		if (TIME.isRecognizedTimePredicate(predicate)){
			...
			if (isDataType){
				...
				if (EventOntology.isInstanceOfTerminology(objIRI, objValue)){
					...
					throw new UnfoundTerminologyException(Util.vf.createIRI(objIRI.stringValue() + objValue));
				}
			}
		}
	}
